...
def mouse_click(x=None,y=None,wait_mouse=0.005):
...
def key_input(str='',input_inteval=0.005,rebound_inteval=0.005):
    for c in str:
...
if __name__ == "__main__":
    time.sleep(3)
    key_input('zz',input_inteval=0.05)
